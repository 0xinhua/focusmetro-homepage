export const metadata = {
  title: "Privacy Policy — Focus Metro",
  description:
    "Privacy Policy for Focus Metro. Learn what information we collect, how we use it, and how we protect your privacy.",
};
...
We, SpeedSound, the developers of Focus Metro app (“Focus Metro”), value your privacy and will uphold the highest standards to protect it. By using Focus Metro or by visiting our website, you acknowledge that you accept the practices and policies outlined in this Privacy Policy.

Focus Metro and the website may contain links to other sites or products and we are not responsible for the privacy policies and/or practices of other companies. When linking to another company, you should read that company’s privacy policy.
...
We do not collect any personal information in Focus Metro or on the website.
...
If you have any questions or concerns regarding privacy, please send us a detailed message to [contact@speedsound.co](mailto:contact@speedsound.co). We will make every effort to resolve your concerns.
...
Email: [contact@speedsound.co](mailto:contact@speedsound.co)
